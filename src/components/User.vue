<template>
	<div class="user-page">
		...
		<div class="tab-panel">
			...
			<div class="current-box scrollable">
				<ul class="comment-list">
					<div v-for="(itm,index) in comments">
						<comment :id="index" :platformSrc="itm.platformSrc" :platformName="itm.platformName" :evOK="itm.evOK" :evNOK="itm.evNOK" :score="itm.score" :evContent="itm.evContent" :commentDate="itm.commentDate" :commentFollow="itm.commentFollow" :commentFollowHref="itm.commentFollowHref"></comment>
					</div>
				</ul>
		...
		<appfooter :active="ftrActive"></appfooter>
	</div>
</template>
	...
	export default {
		...
		data() {
			return {
				...
				comments: [{
						...
						evContent: '不靠谱的平台有几个表象。高调的宣传，铺天盖地的广告2.高管无金融从业经历，无风险意识',
						platformName: "拍拍贷",
						evOK: 43,
						evNOK: 15,
						score: 2.744,
						commentDate: '3小时前',
						commentFollow: '39',
						commentFollowHref: 'javascript:void(0);'
		...
		methods: {
			...
			incTag: function(index, tId) {
				if(this.tagFlag[index] && this.tagFlag[index] == 1) {
					return;
				}
